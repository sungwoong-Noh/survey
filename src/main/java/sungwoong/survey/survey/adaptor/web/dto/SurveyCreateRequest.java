...
public record SurveyCreateRequest(
        @NotBlank(message = "설문조사 제목은 필수입니다.") @Size(max = 100, message = "설문조사 제목은 1글자 이상 100글자 이하여야 합니다.") String title,
        @NotBlank(message = "설문조사 설명은 필수입니다.") @Size(max = 700, message = "설문조사 설명은 1글자 이상 700글자 이하여야 합니다.") String description,
